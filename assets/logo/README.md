...
A capital T traced as the contour of the filled letterform, with the anchor points of that
path left visible. The mark is an instance of what the package makes: turning Unicode into
glyph outlines is the whole job, and an outline is a path with points.
